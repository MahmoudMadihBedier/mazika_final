...
class TrackModel extends HiveObject with EquatableMixin {
  ...
  @HiveField(3) final String albumName;
  @HiveField(4) final String albumImageUrl;
  @HiveField(5) final String previewUrl;
  @HiveField(6) final String spotifyUri;
  @HiveField(7) final int durationMs;
  @HiveField(8) final double energy;
  @HiveField(9) final double valence;
  @HiveField(10) final double tempo;
  @HiveField(11) final double danceability;
  @HiveField(12) final double acousticness;
  @HiveField(13) final double instrumentalness;
  @HiveField(14) final int playCount;
  @HiveField(15) final int skipCount;
  ...
  TrackModel copyWith({int? playCount, int? skipCount, DateTime? lastPlayed}) {
    return TrackModel(
      id: id, title: title, artist: artist, albumName: albumName,
      albumImageUrl: albumImageUrl, previewUrl: previewUrl,
      spotifyUri: spotifyUri, durationMs: durationMs,
  ...
  TrackModel withAudioFeatures(Map<String, dynamic> features) {
    return TrackModel(
      ...
      instrumentalness: (features['instrumentalness'] ?? instrumentalness).toDouble(),
      playCount: playCount, skipCount: skipCount, lastPlayed: lastPlayed,
    );
  }
